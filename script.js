    ...
    if (cliOverlay && cliInput && cliOutput) {
        ...
        const CLI_RESPONSES = {
            about: [
                ...
                '  ventures:  Dhaki, hush.md, GenPWD, HNWI Private Cybersecurity',
            ],
            focus: [
                '  active:    Dhaki — luxury smart automation (Co-Founder)',
                '  active:    hush.md — end-to-end encrypted markdown sharing (Creator)',
                '  active:    GenPWD — secure password generator (Creator)',
                '  running:   private AI agent stack, self-hosted (Architect)',
            ...
            philosophy: [
                ...
                '   Boredom is a signal: something needs to evolve.',
                '  ',
                '   I am a hacker by mindset. No system is a black box,',
                '   including the ones that think.',
                '  ',
                '   AI is the most powerful tool I have ever worked with.',
                '   Least privilege, clear boundaries, and a human who can say no.',
                '  ',
                '   If something can be better, it should be.',
                '   If it holds real power, it must be accountable."',
            ],
            systems: [
